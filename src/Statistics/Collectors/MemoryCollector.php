...
namespace Famitekeg\LaravelWebSockets\Statistics\Collectors;

use Famitekeg\LaravelWebSockets\Contracts\ChannelManager;
use Famitekeg\LaravelWebSockets\Contracts\StatisticsCollector;
use Famitekeg\LaravelWebSockets\Facades\StatisticsStore;
use Famitekeg\LaravelWebSockets\Helpers;
use Famitekeg\LaravelWebSockets\Statistics\Statistic;
...
class MemoryCollector implements StatisticsCollector
{
     ...
     * The Channel manager.
     *
     * @var \Famitekeg\LaravelWebSockets\Contracts\ChannelManager
     */
     ...
     *
     * @param  string|int  $appId
     * @return PromiseInterface[\Famitekeg\LaravelWebSockets\Statistics\Statistic|null]
     */
     ...
     *
     * @param  string|int  $appId
     * @return \Famitekeg\LaravelWebSockets\Statistics\Statistic
     */
     ...
     *
     * @param  \Famitekeg\LaravelWebSockets\Statistics\Statistic  $statistic
     * @param  mixed  $appId
     * @return void
     */

...
namespace Famitekeg\LaravelWebSockets\ChannelManagers;

use Famitekeg\LaravelWebSockets\Channels\Channel;
use Famitekeg\LaravelWebSockets\Channels\PresenceChannel;
use Famitekeg\LaravelWebSockets\Channels\PrivateChannel;
...
class LocalChannelManager implements ChannelManager
{
     ...
     * @return null|Famitekeg\LaravelWebSockets\Channels\Channel
     */
     ...
     * @param  string|int  $appId
     * @param  string  $channel
     * @return Famitekeg\LaravelWebSockets\Channels\Channel
     */

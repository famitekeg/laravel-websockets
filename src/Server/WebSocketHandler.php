...
namespace Famitekeg\LaravelWebSockets\Server;
...
use Famitekeg\LaravelWebSockets\Events\ConnectionClosed;
use Famitekeg\LaravelWebSockets\Events\NewConnection;
use Famitekeg\LaravelWebSockets\Events\WebSocketMessageReceived;
use Famitekeg\LaravelWebSockets\Facades\StatisticsCollector;
use Exception;
...
class WebSocketHandler implements MessageComponentInterface
{
     ...
     *
     * @param  \Famitekeg\LaravelWebSockets\Contracts\ChannelManager  $channelManager
     * @return void
     */

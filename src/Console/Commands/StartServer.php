...
namespace Famitekeg\LaravelWebSockets\Console\Commands;

use Famitekeg\LaravelWebSockets\Contracts\ChannelManager;
use Famitekeg\LaravelWebSockets\Facades\StatisticsCollector as StatisticsCollectorFacade;
use Famitekeg\LaravelWebSockets\Facades\WebSocketRouter;
use Famitekeg\LaravelWebSockets\Server\Loggers\ConnectionLogger;
use Famitekeg\LaravelWebSockets\Server\Loggers\HttpLogger;
use Famitekeg\LaravelWebSockets\Server\Loggers\WebSocketsLogger;
use Famitekeg\LaravelWebSockets\ServerFactory;
...
class StartServer extends Command
{
    ...
    {
        return Cache::get(
            'famitekeg:websockets:restart', 0
        );
    }
